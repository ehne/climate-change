function micromarkupParse(mm){
    ...
    // links
    mm = mm.replace(/[\[]{1}([^\]]+)[\]]{1}[\(]{1}([^\)\"]+)[\)]{1}/g, '<a href="$2" target="_blank" rel="noopener noreferrer">$1</a>');
	...
	// custom superscript and subscript syntax:
	// subscripts: `ˇsubscript‰±ˇ` (option + shift + T on macos)
